...
def ChromaRun(pwl_path, p_path, p_output_dir, numOutputs, chroma_instance):
    mask = torch.zeros(1, 126, device='cuda')
...
def main():
    ...
    for file1, file2 in zip(files1, files2):
        ...
        if len(sys.argv) > 4:
            ...
            ChromaRun(file1_path, file2_path, file_output_dir, additional_arg, chroma_instance)
        else:
            ChromaRun(file1_path, file2_path, file_output_dir, None, chroma_instance)
